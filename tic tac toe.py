...
def main():
    ...
    for i in range(9):
      ...
      for j in mat:
          ...
          print('\n')
      for l in range(3):
         if mat[l][0] == mat[l][1] == mat[l][2] == Q or mat[0][l] == mat[1][l] == mat[2][l] == Q \
            or mat[0][0] == mat[1][1] == mat[2][2] == Q or mat[0][2] == mat[1][1] == mat[2][0] == Q:
             u = 1
             print("Player 1 Wins")
             break
         if mat[l][0] == mat[l][1] == mat[l][2] == W or mat[0][l] == mat[1][l] == mat[2][l] == W \
            or mat[0][0] == mat[1][1] == mat[2][2] == W or mat[0][2] == mat[1][1] == mat[2][0] == W:
             u = 1
             print("Player 2 Wins")
             break
      if i == 8 and u == 0:
